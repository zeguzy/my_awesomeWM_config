...
--下面是tag设置
--local names ={ "a", "w", "e", "s", "o", "m", "e", "w", "m"}
--local l = awful.layout.suit  -- Just to save some typing: use an alias.
--local layouts = { l.tile.left,l.tile.left,l.tile.left,l.floating, l.floating,l.floating}
...
awful.tag.add("server", {
        icon = "/home/zegu/.config/awesome/themes/gtk/icons/apps/server.png",
        layout = awful.layout.suit.tile.left,
        screen = s,
})
awful.tag.add("Scrcpy", {
        icon = "/home/zegu/.config/awesome/themes/gtk/icons/apps/android.png",
...
--            s.mypromptbox,
        ...
        { -- Right widgets
			...
			volumearc_widget({
    			...
    			thickness = 2,
    			height = 35,
				path_to_icon= "/home/zegu/.config/awesome/themes/gtk/icons/status/音量.svg"
...
globalkeys = gears.table.join(
    ...
    --个人快捷键
    awful.key({ modkey            }, "0", function() awful.util.spawn(i3lock_settings) end),
