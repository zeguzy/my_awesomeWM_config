...
gears.table.join(
  ...
  awful.key(
    ...
    { description = "go back", group = "custom" }
  ),
  -- Standard program
  awful.key(
    { modkey },
  ...
  awful.key(
    ...
    "z",
    function()
      awful.screen.focused().popup_tasklist.show()
    end,
    function()
      awful.screen.focused().popup_tasklist.hide()
    end,
    { description = "run browser", group = "launcher" }
  ),
  -- 系统托盘显隐切换
  ...
  awful.key(
    ...
    "n",
    function()
      awful.screen.focused().net_speed_widget.toggle()
    end,
    { description = "run prompt", group = "launcher" }
  ),
...
return { globalkeys = globalkeys, clientkeys = clientkeys, mouseBindings = mouseBindings, clientbuttons = clientbuttons }
