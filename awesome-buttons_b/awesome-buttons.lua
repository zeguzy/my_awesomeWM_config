...
buttons.with_time = function(args)
    local type = args.type or 'basic'
    local format = args.format or '%Y-%m-%d'
    local onclick = args.onclick or function() end
    local color = args.color or '#D8DEE9'
...
buttons.with_widget = function(args)
    local type = args.type or 'basic'
...
buttons.with_icon_and_date = function(args)
...
buttons.with_icon_and_widget = function(args)
